...
export function ResponsePanel({ response, error, isLoading }) {
    ...
    const headerEntries = response
        ...
        : [];
    return (_jsxs("div", { className: "response-panel", children: [_jsxs("div", { className: "response-status-bar", children: [isLoading && (_jsxs("div", { className: "response-loading", children: [_jsx("span", { className: "loading-dot" }), _jsx("span", { className: "loading-dot" }), _jsx("span", { className: "loading-dot" }), _jsx("span", { className: "loading-text", children: "Sending request..." })] })), !isLoading && !response && !error && (_jsxs("div", { className: "response-placeholder", children: ["Hit ", _jsx("kbd", { children: "Send" }), " to get a response"] })), !isLoading && error && (_jsxs("div", { className: "response-error", children: [_jsx("span", { className: "error-icon", children: "\u26A0" }), _jsx("span", { children: error })] })), !isLoading && response && (_jsxs("div", { className: "response-meta", children: [_jsxs("span", { className: `status-badge ${statusClass}`, children: [response.status, " ", response.statusText] }), _jsxs("span", { className: "meta-item", children: [_jsx("span", { className: "meta-label", children: "Time" }), _jsxs("span", { className: "meta-value", children: [response.time, "ms"] })] }), _jsxs("span", { className: "meta-item", children: [_jsx("span", { className: "meta-label", children: "Size" }), _jsx("span", { className: "meta-value", children: formatSize(response.size) })] })] }))] }), response && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "response-tabs", children: [_jsx("button", { className: `tab-btn ${activeTab === 'body' ? 'active' : ''}`, onClick: () => setActiveTab('body'), children: "Body" }), _jsxs("button", { className: `tab-btn ${activeTab === 'headers' ? 'active' : ''}`, onClick: () => setActiveTab('headers'), children: ["Headers", _jsx("span", { className: "tab-badge", children: headerEntries.length })] }), activeTab === 'body' && isJson(response.body) && (_jsxs("div", { className: "view-mode-toggle", children: [_jsx("button", { className: `mode-btn ${viewMode === 'pretty' ? 'active' : ''}`, onClick: () => setViewMode('pretty'), children: "Pretty" }), _jsx("button", { className: `mode-btn ${viewMode === 'raw' ? 'active' : ''}`, onClick: () => setViewMode('raw'), children: "Raw" })] }))] }), _jsxs("div", { className: "response-content", children: [activeTab === 'body' && (_jsx("pre", { className: "response-body", children: _jsx("code", { dangerouslySetInnerHTML: {
