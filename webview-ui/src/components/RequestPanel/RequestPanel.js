...
export function RequestPanel({ request, onChange, onSend, isLoading }) {
    ...
    return (_jsxs("div", { className: "request-panel", children: [_jsxs("div", { className: "url-bar", children: [_jsx("select", { className: "method-select", value: request.method, onChange: (e) => update({ method: e.target.value }), style: { color: METHOD_COLORS[request.method] }, children: METHODS.map((m) => (_jsx("option", { value: m, style: { color: METHOD_COLORS[m] }, children: m }, m))) }), _jsx("input", { className: "url-input", type: "text", placeholder: "https://api.example.com/endpoint", value: request.url, onChange: (e) => update({ url: e.target.value }), onKeyDown: (e) => { if (e.key === 'Enter')
