...
import './Sidebar.css';
export function Sidebar({ collections, activeRequestId, onSelectRequest, onAddCollection, onDeleteCollection, onRenameCollection, onRenameRequest, onDeleteRequest, onNewRequest, onSaveToCollection, onDeleteExample, onLoadExample, }) {
